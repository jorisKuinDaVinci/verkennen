...
function create_button(soortknop){
    ...
    switch(soortknop){
        ...
        case 'place':
            ...
            break;
        case 'remove':
            knop.textContent = 'verwijder cookie';
            knop.addEventListener('click', proccess_addcookies_click);
            break;
        default:
            console.log('.');
...
function build_controlls() {
    ...
    const controlList = [create_button('add'), create_button('take'), create_button('place'), create_button('remove')];
